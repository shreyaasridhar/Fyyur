...
def create_artist_submission():
    ...
    try:
        ...
        # artist = Artist(name='name', city='city', state='state', phone='phone', genres=['Pop'], image_link='image_link', website='website', facebook_link='facebook_link', seeking_venue=True)
